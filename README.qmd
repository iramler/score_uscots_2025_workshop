...
> This page provides information and resources for the [USCOTS 2025 workshop](https://www.causeweb.org/cause/uscots/uscots25/program/workshops/w13){target="_blank"} on creating statistics and data science teaching modules with sports data, hosted by the [SCORE Network](https://scorenetwork.org){target="_blank"}.
...
To help you get started, here are a few [examples modules](https://github.com/iramler/score_uscots_2025_workshop/tree/main/module_examples){target="_blank"} as well as some [ideas to help you start brainstorming your own](https://iramler.github.io/score_uscots_2025_workshop/module_ideas.html){target="_blank"}.
